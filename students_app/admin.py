...
class EmployeeMailReminderAdmin(CreatedByUpdatedByModelBase):
    list_display = ('id', 'title', 'reminder_date', 'is_achieved', 'employee')
...
admin.site.register(EmployeeMailReminder, EmployeeMailReminderAdmin)
